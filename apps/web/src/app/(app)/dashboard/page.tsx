      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto overflow-hidden">
        ...
        <main className="flex-1 p-4 sm:p-8 overflow-y-auto space-y-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="glass-card rounded-2xl p-4 border border-zinc-800 space-y-1">
              <span className="text-zinc-500 text-[11px] font-semibold uppercase tracking-wider flex items-center gap-1.5">
                <Bookmark size={13} className="text-indigo-400" /> Total Links
              </span>
              <p className="text-2xl font-extrabold text-zinc-100">{links.length}</p>
              <p className="text-[11px] text-zinc-500">{totalValidDomainLinks} with parsed web domains</p>
            </div>

            <div className="glass-card rounded-2xl p-4 border border-zinc-800 space-y-1">
              <span className="text-zinc-500 text-[11px] font-semibold uppercase tracking-wider flex items-center gap-1.5">
                <Clock size={13} className="text-amber-400" /> To Read
              </span>
              <p className="text-2xl font-extrabold text-amber-400">{toReadCount}</p>
            ...
            <div className="glass-card rounded-2xl p-4 border border-zinc-800 space-y-1">
              <span className="text-zinc-500 text-[11px] font-semibold uppercase tracking-wider flex items-center gap-1.5">
                <BookOpen size={13} className="text-indigo-400" /> Currently Reading
              </span>
              <p className="text-2xl font-extrabold text-indigo-400">{readingCount}</p>
              <p className="text-[11px] text-zinc-500">In-progress content</p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-4 border border-zinc-800 space-y-1">
              ...
              <p className="text-2xl font-extrabold text-emerald-400">{doneCount}</p>
              <p className="text-[11px] text-zinc-500">
          ...
          <div className="glass-card rounded-2xl p-5 border border-zinc-800 space-y-3">
            <h2 className="text-sm font-semibold text-zinc-200">Reading Progress Distribution</h2>
                    ...
                    <div key={item.domain} className="space-y-1 text-xs">
                      <div className="flex items-center justify-between font-mono">
                        <span className="text-zinc-200 font-medium flex items-center gap-2">
                          <span className="text-zinc-500 font-mono text-[11px] w-5">#{idx + 1}</span>
                          <span>{item.domain}</span>
                        </span>
                        <span className="text-zinc-400 font-semibold">{item.count} links</span>
                      </div>
