...
import { Bookmark, ArrowRight, Mail, AlertCircle, CheckCircle2, Loader2, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-3">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-zinc-100">Reset your password</h2>
        <p className="text-xs text-zinc-500">We will send you a secure link to reset your password</p>
      </div>
        ...
        <div className="glass-card py-8 px-6 sm:px-10 rounded-3xl border border-zinc-800 space-y-6">
          ...
          {isSuccess ? (
            <div className="space-y-4 text-center py-2">
              ...
              <h3 className="text-sm font-semibold text-zinc-100">Reset Link Sent</h3>
              <p className="text-xs text-zinc-400">
                If an account exists for <span className="text-zinc-200 font-medium">{email}</span>, you will receive an email shortly with instructions to reset your password.
              </p>
              <Link
                href="/login"
                className="inline-flex items-center gap-1.5 text-xs font-semibold text-indigo-400 hover:text-indigo-300 transition-colors pt-2"
              >
                <ArrowLeft size={14} />
