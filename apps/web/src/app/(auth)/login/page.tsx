  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] dark:bg-zinc-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 transition-colors duration-150">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-3">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-zinc-100">Sign in to Linkiac</h2>
        <p className="text-xs text-gray-500 dark:text-zinc-400">Access your universal link library and private suggestions</p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
        <div className="glass-card py-8 px-6 sm:px-10 rounded-3xl border border-gray-200 dark:border-zinc-800 space-y-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="login-identifier" className="block text-xs font-semibold text-gray-700 dark:text-zinc-400 mb-1.5 uppercase tracking-wider">
                Email or Username
              </label>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="login-password" className="block text-xs font-semibold text-gray-700 dark:text-zinc-400 uppercase tracking-wider">
                  Password
                </label>
                <Link
                  href="/forgot-password"
                  className="text-[11px] text-[#093329] dark:text-[#BCD94E] hover:underline font-medium transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="text-center text-xs text-gray-500 dark:text-zinc-400">
            ...
            <Link href="/signup" className="text-[#093329] dark:text-[#BCD94E] hover:underline font-semibold">
              Create an account
            </Link>
          </p>
        </div>
