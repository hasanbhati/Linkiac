...
import { Bookmark, ArrowRight, Lock, Mail } from 'lucide-react';
        ...
        <div className="glass-card py-8 px-6 sm:px-10 rounded-3xl border border-zinc-800 space-y-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2.5 px-4 rounded-xl text-xs font-semibold text-white bg-indigo-600 hover:bg-indigo-500 shadow-md shadow-indigo-600/20 active:scale-95 transition-all flex items-center justify-center gap-1.5"
            >
          ...
          <button
            ...
            className="w-full py-2.5 px-4 rounded-xl border border-zinc-800 bg-zinc-950 hover:bg-zinc-800/60 text-xs font-semibold text-zinc-200 transition-colors flex items-center justify-center gap-2"
          >
