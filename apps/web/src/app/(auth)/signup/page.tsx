...
import { Bookmark, ArrowRight, Lock, Mail, AtSign, User } from 'lucide-react';
        ...
        <div className="glass-card py-8 px-6 sm:px-10 rounded-3xl border border-zinc-800 space-y-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <p className="text-[10px] text-zinc-500 mt-1">Searchable by friends for sending recommendations.</p>
            </div>
